...
class NonSerializedInventoryPage extends StatefulWidget {
  ...
  NonSerializedInventoryPage(this.fulfillmentInfo, {Key? key}) : super(key: key);

  @override
  _NonSerializedInventoryPage createState() => _NonSerializedInventoryPage(fulfillmentInfo);
}

class _NonSerializedInventoryPage extends State<NonSerializedInventoryPage> {
  var fulfillmentInfo;

  _NonSerializedInventoryPage(this.fulfillmentInfo);
